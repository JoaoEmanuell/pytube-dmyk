...
from .__init_vars__ import __js_url__, __js__
...
class YouTube:
    ...
    def watch_html(self):
        ...
        self._watch_html = get(url=self.watch_url)
        return self._watch_html
    ...
    def embed_html(self):
        ...
        self._embed_html = get(url=self.embed_url)
        return self._embed_html
    ...
    def age_restricted(self):
        ...
        self._age_restricted = is_age_restricted(self.watch_html)
        return self._age_restricted
    ...
    def js_url(self):
        ...
        if self.age_restricted:
            self._js_url = js_url(self.embed_html)
        else:
            self._js_url = js_url(self.watch_html)
    ...
    def initial_data(self):
        ...
        self._initial_data = initial_data(self.watch_html)
        return self._initial_data
    ...
    def fmt_streams(self):
        ...
        stream_manifest = apply_descrambler(self.streaming_data)

        # If the cached js doesn't work, try fetching a new js file
        # https://github.com/pytube/pytube/issues/1054
        try:
            apply_signature(stream_manifest, self.vid_info, self.js)
        except ExtractError:
    ...
    def check_availability(self):
        ...
        """
        status, messages = playability_status(self.watch_html)
    ...
    def metadata(self) -> Optional[YouTubeMetadata]:
        ...
        if self._metadata:
            ...
            self._metadata = metadata(self.initial_data)
            return self._metadata
